...
//! указания типов
//! переменные let number: TYPE = 20
//! тип возвращаемый из функции const sum = (): TYPE => {}
//! "" 
...
//! unknown - присваивает любое значение как и any, но мы не сможем есго использовать(обращатьсся к полям класса, вызывать функции и т.д) без удтверждения типа. 
let a2 = 's'
a2 as const
...
//* Только для установленной длины, тут 2 жлемента
...
//! Индексирвемые поля - [name: string]: User - это значит что это поле имеет ключ тип String и значения типа User
type Proger = {
